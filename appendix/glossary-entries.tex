...
\newglossaryentry{confluenceg} {
    name=\glslink{confluenceg}{Confluence},
    text=Confluence,
    sort=confluence,
...
\newglossaryentry{repositoryg} {
    ...
    text=repository,
    sort=repository,
    description={In informatica con il termine \emph{repository} si indica un ambiente di archiviazione centralizzato dedicato alla gestione e al versionamento del codice sorgente}
}
