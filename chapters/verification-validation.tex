...
\intro{In questo capitolo sono descritti i processi di verifica e validazione del prodotto.
In particolare sono illustrati i test implementati, i risultati ottenuti e le possibili migliorie future del prodotto.
}
...
\begin{center}
  \captionof{table}{Tabella del tracciamento dei test di unità dei Components}\label{tab:test-unita-componenti}
  \begin{longtable}{|c|c|p{0.5\textwidth}|c|}
  \hline
  \textbf{Codice} & \textbf{Oggetto} & \textbf{Descrizione} & \textbf{Stato}\\
  \hline
  ...
  \hline
  TU-14 &Chip &Verifica la corretta visualizzazione del \textit{client-id} corrente, verificando inoltre la fun\-zio\-na\-li\-tà di reset &S \\
  \hline
