...
\begin{center}
  ...
  \hline
  TU-9 &LogoutButton &Verifica il corretto funzionamento del logout con \textit{popup} di un utente &S \\
  \hline
  TU-10 &LoginButton &Verifica il corretto funzionamento del login con \textit{popup} di un utente &S \\
  \hline
