...
\begin{itemize}
  ...
  \item \textbf{\textit{Service}}: contiene la logica di \textit{business} dell'applicazione. I \textit{Service} sono responsabili della gestione dei dati e dell'interazione con le risorse esterne.
\end{itemize}