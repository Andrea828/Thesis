...
Allo stesso tempo rendono però più complessa la consultazione delle \textit{API} esposte e aumentano la quantità di comunicazione necessaria per mantenere tutti i reparti allineati.
...
lo schema \textit{YAML} di ogni singola \textit{API}.
