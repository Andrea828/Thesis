...
\textit{MainContent}. Il \textit{loader} è visibile subito dopo aver effettuato il login o quando la pagina viene ricaricata, e scompare una volta che i dati saranno stati caricati correttamente.
