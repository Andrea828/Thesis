...
\begin{figure}[h]
    \makebox[\textwidth][c]{%
        \includegraphics[width=1.2\textwidth]{images/usecase/scenario-principale.jpg}%
    }%
...
\begin{figure}[!ht] 
    \centering 
    \includegraphics[width=0.85\columnwidth, alt={Caso d'uso relativo al login}]{images/usecase/UC2.jpg}
...
\begin{figure}[!ht] 
    \centering 
    \includegraphics[width=0.85\columnwidth, alt={Caso d'uso relativo alla prova di un endpoint}]{images/usecase/UC8.jpg}
