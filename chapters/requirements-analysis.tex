...
\begin{itemize}
    ...
    \item \textbf{Microsoft 365}: è un servizio di autenticazione di \textit{Microsoft} che permette di autenticarsi tramite \textit{\textit{account}} aziendale.
...
\begin{usecase}{8}{Try it out \textit{endpoint}}\label{uc:try-it-out-endpoint}
    \usecaseactors{Utente autenticato}
