...
Nel contesto aziendale di THRON, vengono adottate metodologie di sviluppo \glsfirstoccur{\gls{agileg}}~\cite{site:agile-manifesto} per garantire un'efficace
...
Il \glsfirstoccur{\gls{frameworkg}} \glsfirstoccur{\gls{scrumg}} [~\cite{site:scrum}], parte integrante dell'approccio \textit{Agile}, è utilizzato all'interno dell'azienda per organizzare il lavoro in iterazioni chiamate
