...
Il \textit{framework} \glsfirstoccur{\gls{scrumg}}, parte integrante dell'approccio \textit{Agile}, è utilizzato all'interno dell'azienda per organizzare il lavoro in iterazioni chiamate
